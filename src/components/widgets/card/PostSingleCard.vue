<template>
  <v-card>
    <v-responsive :src="img" :height="imageHeight" class="white--text">
        ...
        <div class="post--action align-center justify-space-between mt-2">
          <div class="social">
            ...
            <a @click="handleComment" class="grey--text mx-3">
              <v-icon small>mdi-mode-comment</v-icon>
              <small>12+</small>
            </a>
            <a @click="handleFavorite" class="grey--text ">
              <v-icon small>mdi-favorite</v-icon>
              <small>50+</small>
            </a>
          </div>
...
export default {
  ...
  data: () => ({
    img: require("@/assets/images/idoles/1.jpg"),
  }),
  methods: {
    handleThumb() {
